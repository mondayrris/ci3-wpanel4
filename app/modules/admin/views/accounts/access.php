...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><i class="fa fa-eye"></i> <?= wpn_lang('module_access'); ?></li>
    </ol>
</section>
...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><?= wpn_lang('module_access'); ?></h3>
            <div class="box-tools pull-right">
                <?= anchor('admin/accounts', glyphicon('chevron-left') . wpn_lang('wpn_bot_back'), array('class' => 'btn btn-sm btn-primary')); ?>
            </div>
        </div>
        <div class="box-body">
